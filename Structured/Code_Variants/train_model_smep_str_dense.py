...
from model_smep_str_dense import Network


def train_net(net):
    print "Learning rule: SMEP, Structured connections"
    print "Code version: all but last fwd matrix are sparse, last fwd matrix is dense"
    path = net.path
...
if __name__ == "__main__":
    ...
    train_net(Network("/trial_local", net1_structured))
